...
divide= Button(btns_frame,image=divide_img,borderwidth=0,command=lambda :btn_click("/")).grid(row = 0, column = 3)
...
minus= Button(btns_frame,image=minus_img,borderwidth=0,command=lambda :btn_click("+")).grid(row = 2, column = 3)
...
equals= Button(btns_frame,image=equal_img,borderwidth=0,command=lambda :btn_equal()).grid(row = 4, column = 3)
